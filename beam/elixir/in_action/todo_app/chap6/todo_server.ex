...
defmodule TodoServer do
  ...
  def handle_cast({:update_entry, old_entry_id, updater}, todo_list) do
    TodoList.update_entry(todo_list, old_entry_id, updater)
  end

  def handle_cast({:delete_entry, target_entry_id}, todo_list) do
    TodoList.delete_entry(todo_list, target_entry_id)
  end
  ...
  def handle_call({:get_todo_list}, todo_list) do
    {todo_list, todo_list}
  end
  ...
  def update_entry(todo_server, old_entry_id, updater) do
    ServerProcess.cast(todo_server, {:update_entry, old_entry_id, updater})
  end

  def delete_entry(todo_server, target_entry_id) do
    ServerProcess.cast(todo_server, {:delete_entry, target_entry_id})
  end

  def get_todo_list(todo_server) do
    ServerProcess.call(todo_server, {:get_todo_list})
  end
