module App.AffExample.Network where
...
handleAction = case _ of
  ...
  MakeRequest event -> do
    ...
    res <- H.liftAff $ AX.get AXRF.string ("https://api.github.com/users/" <> username)
    H.modify_ _ { loading = false, result = map _.body (hush res) }
